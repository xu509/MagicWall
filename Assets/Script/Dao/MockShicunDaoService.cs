...
namespace MagicWall
{
    public class MockShicunDaoService : MonoBehaviour, IDaoService
    {
        ...
        private Dictionary<int, Product> _product2Map;
        ...
        public List<Product> GetProducts()
        {
            if (_products == null)
            {
                ...
                "shicun\\互动魔墙里的酒图片\\丽隆红酒\\包装礼盒.jpg",
                ...
                "shicun\\互动魔墙里的酒图片\\默顿红酒\\主视觉-1.jpg",
                "shicun\\互动魔墙里的酒图片\\默顿红酒\\主视觉-2.jpg",
                "shicun\\互动魔墙里的酒图片\\默顿红酒\\主视觉-3.jpg"
            };
                imageCovers.Add(i16);
            ...
            if (_products2 == null)
            {
                _product2Map = new Dictionary<int, Product>();
        ...
        private void AddProduct2(string[] details, string name, int proid)
        {
            ...
            for (int i = 0; i < details.Length; i++)
            {
                ...
                _product2Map.Add(pro_id, product);
