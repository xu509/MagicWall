...
namespace MagicWall
{
    public class MockAQGBLogoDaoService : MonoBehaviour, IDaoService
    {
        ...
        //  Construct
        //
        protected MockAQGBLogoDaoService() { }
        ...
        public void InitData()
        {
            ...
            string enterprisePath = "AQB\\logo\\";
        ...
        {
            bool hasLogo = false;
            string enterprisePath = "AQB\\logo\\" + name;
        ...
        private void AddCatalogByEnterprise(string name, int ent_id)
        {
            ...
            string catalogDirPath = "AQB\\logo\\" + name + "\\catalog";
        ...
        private void AddProductByEnterprise(string name, int ent_id)
        {
            ...
            string catalogDirPath = "AQB\\logo\\" + name + "\\产品";
        ...
        private void AddActivityByEnterprise(string name, int ent_id)
        {
            ...
            string activityDirPath = "AQB\\logo\\" + name + "\\活动";
        ...
        {
            string catalogDirPath = "AQB\\logo\\" + name + "\\企业名片";
        ...
        private void AddVideo(string name, int ent_id)
        {
            ...
            string videoDirPath = "AQB\\logo\\" + name + "\\视频";
