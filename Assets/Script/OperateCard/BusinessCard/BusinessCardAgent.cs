...
namespace MagicWall
{
    public class BusinessCardAgent : MonoBehaviour
    {
        ...
        private Action _onUpdatedAction;
        ...
        public void Init(string[] images, float cardWidth, Vector2 position, Action onHandleUpdateAction
            , Action onClickCloseAction,Action onUpdatedAction)
        {

            _onHandleUpdateAction = onHandleUpdateAction;
            _onClickCloseAction = onClickCloseAction;
            _onUpdatedAction = onUpdatedAction;
